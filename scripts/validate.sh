...
required_files=(
  ...
  "examples/opportunities/backblaze-review-decision.json"
  ...
  "tests/fixtures/devpost-event.html"
  "tests/fixtures/devpost-hackathons.json"
  "tests/fixtures/devpost-rule-home.html"
  "tests/fixtures/devpost-rule-rules.html"
